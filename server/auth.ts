...
export function setupAuth(app: Express) {
  const sessionSettings: session.SessionOptions = {
    secret: process.env.SESSION_SECRET || "pharmacy-management-secret",
    resave: false,
  ...
  app.use((req, res, next) => {
    // Adding role checking middleware to be used for protected routes
    req.hasRole = (roles: string | string[]) => {
